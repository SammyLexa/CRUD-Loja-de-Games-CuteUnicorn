...
- [Back-End, Documentação, Diagrama de Classes e outros Detalhes](https://github.com/SammyLexa/CRUD-Loja-de-Games)
...
O software é um E-commerce, focado na venda de jogos eletrônicos e outros produtos desse nicho. Capaaz de Realizar todas funções CRUD(Criar, Consultar, Atualizar e 
Deletar).
